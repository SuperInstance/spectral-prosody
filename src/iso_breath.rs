...
use crate::metrical_graph::{MetricalLine, MetricalGraph};
...
pub fn isospectral_check(sig_a: &SpectralSignature, sig_b: &SpectralSignature, tolerance: f64) -> bool {
...
pub fn breath_equivalent_line(source: &MetricalLine, target_syllables: usize, target_stresses: Vec<bool>, language: &str) -> MetricalLine {
...
pub fn breath_constrained_traditions() -> Vec<(&'static str, Vec<MetricalLine>)> {
    vec![
        ("English Iambic Pentameter", vec![
            MetricalLine::new(vec![1.0; 10], vec![false, true, false, true, false, true, false, true, false, true], "English".into()),
            MetricalLine::new(vec![1.0; 10], vec![false, true, false, true, false, true, false, true, false, true], "English".into()),
            MetricalLine::new(vec![1.0; 10], vec![false, true, false, true, false, true, false, true, false, true], "English".into()),
        ]),
        ("Sanskrit Sloka", vec![
            MetricalLine::new(vec![0.625; 16], vec![false, true, false, true, false, true, false, false, false, true, false, true, false, true, false, false], "Sanskrit".into()),
            MetricalLine::new(vec![0.625; 16], vec![false, true, false, true, false, true, false, false, false, true, false, true, false, true, false, false], "Sanskrit".into()),
            MetricalLine::new(vec![0.625; 16], vec![false, true, false, true, false, true, false, false, false, true, false, true, false, true, false, false], "Sanskrit".into()),
        ]),
        ("French Alexandrine", vec![
            MetricalLine::new(vec![0.833; 12], vec![false, false, false, true, false, false, false, false, false, true, false, false], "French".into()),
            MetricalLine::new(vec![0.833; 12], vec![false, false, false, true, false, false, false, false, false, true, false, false], "French".into()),
            MetricalLine::new(vec![0.833; 12], vec![false, false, false, true, false, false, false, false, false, true, false, false], "French".into()),
        ]),
        ("Arabic Rajaz", vec![
            // Rajaz: 6+6+6 syllable pattern (3=iambic-like feet)
            MetricalLine::new(vec![0.833; 12], vec![false, true, false, true, false, true, false, true, false, true, false, true], "Arabic".into()),
            MetricalLine::new(vec![0.833; 12], vec![false, true, false, true, false, true, false, true, false, true, false, true], "Arabic".into()),
            MetricalLine::new(vec![0.833; 12], vec![false, true, false, true, false, true, false, true, false, true, false, true], "Arabic".into()),
        ]),
    ]
...
pub fn test_iso_breath_conjecture(tolerance: f64) -> Vec<(String, String, f64, bool)> {
    ...
    let signatures: Vec<SpectralSignature> = traditions.iter().map(|(name, lines)| {
    ...
    for i in 0..signatures.len() {
        for j in (i + 1)..signatures.len() {
            let dist = signatures[i].normalized().distance_to(&signatures[j].normalized());
            let iso = dist < tolerance;
            results.push((signatures[i].tradition.clone(), signatures[j].tradition.clone(), dist, iso));
        }
    }
    results
}
...
mod tests {
    ...
    fn test_breath_cost_iambic() {
        let line = MetricalLine::new(vec![1.0; 10], vec![false, true, false, true, false, true, false, true, false, true], "English".into());
    ...
    fn test_iambic_and_sanskrit_spectrally_close() {
        ...
        assert!(sim > 0.5, "Iambic and Sanskrit sloka should be spectrally related, cosine={}", sim);
    }
    ...
    fn test_breath_equivalent_line() {
        let source = MetricalLine::new(vec![1.0; 10], vec![false, true, false, true, false, true, false, true, false, true], "English".into());
